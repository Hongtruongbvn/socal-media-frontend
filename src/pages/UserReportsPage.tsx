...
const UserReportsPage: React.FC = () => {
  ...
  if (loading) return <div className="user-reports"><p>⏳ Đang tải...</p></div>;
  if (reports.length === 0) return <div className="user-reports"><p>📭 Không có báo cáo nào cho người dùng này.</p></div>;
