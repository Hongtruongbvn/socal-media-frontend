    ...
    <div className="cgx-backdrop" onClick={onClose}>
      <div className="cgx-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="cgx-body">
          <label className="cgx-label">🖼️ Ảnh nhóm (không bắt buộc)</label>
          <div className="cgx-avatar-picker">
            {avatarPreview ? (
              <div className="cgx-avatar-preview">
                <img src={avatarPreview} alt="preview" />
                <button type="button" className="cgx-btn small" onClick={clearAvatar}>🗑️ Xóa ảnh</button>
              </div>
            ) : (
              <>
          ...
          <label className="cgx-label">🏷️ Tên nhóm (không bắt buộc)</label>
          <input
            className="cgx-input"
        ...
        <div className="cgx-footer">
          <button onClick={onClose} className="cgx-btn">Hủy bỏ</button>
